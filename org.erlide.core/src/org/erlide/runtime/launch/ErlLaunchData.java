...
public final class ErlLaunchData {
    ...
    public final String wrapperScript;
    ...
    public ErlLaunchData(final ILaunchConfiguration config,
        ...
        loadAllNodes = config.getAttribute(ErlLaunchAttributes.LOAD_ALL_NODES,
                false);
        wrapperScript = config.getAttribute(ErlLaunchAttributes.WRAPPER_SCRIPT,
                (String) null);
        remoteHost = config.getAttribute(ErlLaunchAttributes.REMOTE_HOST,
                (String) null);
    }
    ...
    public void debugPrint(final String mode) {
        ...
        if (wrapperScript != null) {
            ErlLogger.info("  wrapperScript: " + wrapperScript);
        }
        if (remoteHost != null) {
            ErlLogger.info("  remoteHost: " + remoteHost);
        }
        if (startMe) {
