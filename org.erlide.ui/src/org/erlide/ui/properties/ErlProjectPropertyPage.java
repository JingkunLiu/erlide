...
public class ErlProjectPropertyPage extends PropertyPage {
	...
	protected Control createContents(final Composite parent) {
		...
		}
		{
			...
			formData_3.right = new FormAttachment(btnBrowse, -8);
			{
				FormData formData = new FormData();
				formData.bottom = new FormAttachment(output_text, 0, SWT.BOTTOM);
				formData.left = new FormAttachment(btnFolder, 0, SWT.LEFT);
				formData.width = 84;
		...
		}
		{
			...
			final Tree sources_tree = treeViewer.getTree();
			{
				...
				formData_10.top = new FormAttachment(lblSourceFoldersIn, 6);
				formData_10.left = new FormAttachment(0, 10);
				formData_10.right = new FormAttachment(btnSource, -6);
				sources_tree.setLayoutData(formData_10);
			}
		}

		Label lblOutputDirectory = new Label(sourceComposite, SWT.NONE);
		formData_10.bottom = new FormAttachment(lblOutputDirectory, -6);
		FormData formData_6 = new FormData();
		formData_6.bottom = new FormAttachment(output_text, -6);
		formData_6.left = new FormAttachment(lblSourceFoldersIn, 0, SWT.LEFT);
		lblOutputDirectory.setLayoutData(formData_6);
		lblOutputDirectory.setText("Output directory:");
		sourceComposite.setTabList(new Control[] { btnFolder, btnSource,
				btnEdit, btnRemove, output_text, btnBrowse });
		...
		TabItem testSourceTab = new TabItem(tabFolder, 0);
		testSourceTab.setText("Test sources");

		final Composite testSourceComposite = new Composite(tabFolder, SWT.NONE);
		testSourceComposite.setLayout(new FormLayout());
		testSourceComposite.setBounds(0, 0, 443, 305);
		testSourceTab.setControl(testSourceComposite);
		{
			lblSourceFoldersIn = new Label(testSourceComposite, SWT.NONE);
			{
				formData_2 = new FormData();
				formData_2.right = new FormAttachment(100);
				formData_2.left = new FormAttachment(0, 8);
		...
		{
			btnFolder = new Button(testSourceComposite, SWT.NONE);
			formData_2.bottom = new FormAttachment(btnFolder, -6);
			{
				formData_5 = new FormData();
				formData_5.right = new FormAttachment(100);
		...
		{
			btnSource = new Button(testSourceComposite, SWT.NONE);
			formData_5.bottom = new FormAttachment(btnSource, -6);
			btnSource.setEnabled(false);
			{
				FormData formData = new FormData();
		...
		{
			btnEdit = new Button(testSourceComposite, SWT.NONE);
			{
				formData_4 = new FormData();
				formData_4.right = new FormAttachment(100);
				formData_4.width = 84;
		...
		{
			btnRemove = new Button(testSourceComposite, SWT.NONE);
			formData_4.bottom = new FormAttachment(btnRemove, -6);
			{
				FormData formData = new FormData();
				formData.right = new FormAttachment(100);
		...
		{
			TreeViewer treeViewer = new TreeViewer(testSourceComposite,
					SWT.BORDER);
			final Tree sources_tree = treeViewer.getTree();
			{
				FormData formData = new FormData();
				formData.bottom = new FormAttachment(lblSourceFoldersIn, 326,
						SWT.BOTTOM);
				formData.left = new FormAttachment(0, 10);
		...
		testSourceComposite.setTabList(new Control[] { btnFolder, btnSource,
				btnEdit, btnRemove });
